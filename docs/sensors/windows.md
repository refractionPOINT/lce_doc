...
The Window sensor is one of LimaCharlie's EDR-class sensors. It's low-level and light-weight, interfacing with the kernel to acquire deep visibility into the host's activity while taking measures to preserve the host's performance. 
